...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/crm/**").hasAnyRole("VENDEDOR", "GERENTE", "ADMIN")
                        .requestMatchers("/api/vendas/**").hasAnyRole("VENDEDOR", "GERENTE", "ADMIN")
    ...
    public AuthenticationProvider authenticationProvider() {
        ...
        authProvider.setPasswordEncoder(encoderConfig.passwordEncoder());  // Spring injeta automaticamente do EncoderConfig
        return authProvider;
    }
